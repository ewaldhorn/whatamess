...
pub const Planet = enum {
    ...
    pub fn age(self: Planet, seconds: usize) f64 {
        const earth_time = @as(f64, @floatFromInt(seconds)) / earthYearInSeconds;

        switch (self) {
            .earth => return earth_time,
            .mercury => return earth_time / 0.2408467,
            .venus => return earth_time / 0.61519726,
            .mars => return earth_time / 1.8808158,
            .jupiter => return earth_time / 11.862615,
            .saturn => return earth_time / 29.447498,
            .uranus => return earth_time / 84.016846,
            .neptune => return earth_time / 164.79132,
        }
