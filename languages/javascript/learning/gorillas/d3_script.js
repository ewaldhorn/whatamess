...
Follow me on X for more: https://twitter.com/HunorBorbely
...
function calculateScale() {
    ...
    console.log(window.innerWidth / totalWidthOfTheCity, window.innerWidth, totalWidthOfTheCity, (window.innerWidth / totalWidthOfTheCity) ?? 1);
