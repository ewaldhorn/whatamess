...
func TestCreateProduct(t *testing.T) {
	...
	// the id is compared to 1.0 because JSON unmarshal converts numbers to
...
func addProducts(count int) {
	...
	for i := 0; i < count; i++ {
		testApp.DB.Exec("INSERT INTO products(name, price) VALUES($1, $2)", "Product "+strconv.Itoa(i), (i+1.0)*10)
	}
}
